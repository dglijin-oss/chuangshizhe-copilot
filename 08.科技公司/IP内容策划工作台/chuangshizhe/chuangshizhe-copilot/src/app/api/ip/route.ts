  ...
  try {
    ...
    const ip = await prisma.ip.create({
      data: {
        ...
        founderTraits: Array.isArray(founderTraits) ? founderTraits : founderTraits || null,
        industry: industry || null,
        products: Array.isArray(products) ? products : products || null,
        targetClients: Array.isArray(targetClients) ? targetClients : targetClients || null,
        accountGoals: Array.isArray(accountGoals) ? accountGoals : accountGoals || null,
        contentBan: Array.isArray(contentBan) ? contentBan : contentBan || null,
